...
func ImportChain(chain *core_eth.BlockChain, fn string) error {
...
func missingBlocks(chain *core_eth.BlockChain, blocks []*types.Block) []*types.Block {
...
func ExportChain(blockchain *core_eth.BlockChain, fn string) error {
...
func ExportAppendChain(blockchain *core_eth.BlockChain, fn string, first uint64, last uint64) error {
	log.Info("Exporting blockchain", "file", fn)
