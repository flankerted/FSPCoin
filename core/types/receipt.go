...
func (r *Receipt) String2() string {
	return fmt.Sprintf("PostState=0x%x Status=%v CumulativeGasUsed=%v TxHash=0x%x ContractAddress=0x%x GasUsed=%v", r.PostState, r.Status, r.CumulativeGasUsed, r.TxHash, r.ContractAddress, r.GasUsed)
}
