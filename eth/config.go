...
var DefaultConfig = Config{
	SyncMode: downloader.FullSync, // qiweiyou: FastSync, to avoid "state node c0bf5c…3e3992 failed with all peers (1 tries, 1 peers)"
	...
	ElectionPool: core.DefaultElectionPoolCfg,
	GPO: gasprice.Config{
		Blocks:     20,
		Percentile: 60,
	},
...
type Config struct {
	...
	// Election pool options
	ElectionPool core.ElectionPoolCfg
