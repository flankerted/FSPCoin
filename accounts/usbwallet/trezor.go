...
import (
	...
	"github.com/contatract/go-contatract/accounts/usbwallet/internal/trezor"
...
func (w *trezorDriver) SignTx(path accounts.DerivationPath, tx interface{}, chainID *big.Int) (common.Address, interface{}, error) {
	if w.device == nil {
		return common.Address{}, nil, accounts.ErrWalletClosed
	}
	if value, ok := tx.(*types.Transaction); ok {
		w.trezorSign(path, value, chainID)
	}
	return common.Address{}, nil, common.ErrInterfaceType
}
