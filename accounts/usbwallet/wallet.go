...
import (
	...
	"github.com/contatract/go-contatract"
...
type driver interface {
	...
	SignTx(path accounts.DerivationPath, tx interface{}, chainID *big.Int) (common.Address, interface{}, error)
}
...
func (w *wallet) SignTx(account accounts.Account, tx interface{}, chainID *big.Int) (interface{}, error) {
...
// Added by JiangHan for continuous private key usage
func (w *wallet) GetKeyCopy( account accounts.Account, passphrase string )(*ecdsa.PrivateKey, error ){
	return nil, accounts.ErrNotSupported
}
// Add end
...
func (w *wallet) SignTxWithPassphrase(account accounts.Account, passphrase string, tx interface{}, chainID *big.Int) (interface{}, error) {
	if value, ok := tx.(*types.Transaction); ok {
		return w.SignTx(account, value, chainID)
