...
// https://github.com/ethereum/go-contatract/pull/15549.
...
func (s *StateSuite) TestTouchDelete(c *check.C) {
	...
	// 增加完毕，我们查一下stateObjectsDirty 是否为1，也就是有一个设置了 struct{}{},其他都是struct{}为0
