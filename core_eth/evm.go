...
func NewEVMContext(msg Message, header *types.Header, chain ChainContext, author *common.Address) vm.Context {
	...
	return vm.Context{
		...
		Time:        new(big.Int).SetInt64(header.Time.Int64() / 1000),
...
// Act Operate
func ActOperate(db vm.StateDB, sender common.Address, actType uint8, actData []byte) {
	db.ActOperate(sender, actType, actData)
}
