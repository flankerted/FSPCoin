...
func (l *txList) Filter(addr common.Address, costLimit *big.Int, gasLimit uint64) (types.Transactions, types.Transactions) {
	...
	removed := l.txs.Filter(func(tx *types.Transaction) bool {
		if common.GetConsensusBftTest() && addr.Equal(*tx.To()) {
			return false
		}
