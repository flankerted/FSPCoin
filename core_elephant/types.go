...
type Validator interface {
	...
	ValidateBody(block *types.Block, verifyBFT bool) error
...
type Processor interface {
	Process(block *types.Block, statedb *state.StateDB, lampHeight uint64, eBase *common.Address) (types.Receipts, uint64, error)
}
