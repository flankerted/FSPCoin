...
func (l *txList) Filter(costLimit *big.Int, gasLimit uint64, lampHeight uint64) (types.Transactions, types.Transactions) {
	...
	removed := l.txs.Filter(func(tx *types.Transaction) bool {
		return (!tx.IsFreeAct(lampHeight) && tx.Cost().Cmp(costLimit) > 0) || tx.Gas() > gasLimit
	})
