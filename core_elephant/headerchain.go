...
func NewHeaderChain(chainDb ethdb.Database, config *params.ElephantChainConfig, engine consensus.EngineCtt, procInterrupt func() bool) (*HeaderChain, error) {
...
func (hc *HeaderChain) WriteHeader(header *types.Header) (status WriteStatus, err error) {
	...
	if localTd != nil && (externTd.Cmp(localTd) > 0 || (externTd.Cmp(localTd) == 0 && mrand.Float64() < 0.5)) {
...
func (hc *HeaderChain) ValidateHeaderChain(chain []*types.Header, checkFreq int) (int, error) {
	...
	//for i := 0; i < len(chain)/checkFreq; i++ {
...
func (hc *HeaderChain) ElephantConfig() *params.ElephantChainConfig { return hc.config }

// Config retrieves the header chain's chain configuration.
func (hc *HeaderChain) Config() *params.ChainConfig { return nil }

// Engine retrieves the header chain's consensus engine.
func (hc *HeaderChain) Engine() consensus.EngineCtt { return hc.engine }
