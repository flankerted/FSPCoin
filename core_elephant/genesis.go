...
type Genesis struct {
	Config     *params.ElephantChainConfig `json:"config"`
	...
	ParentNoBftHash common.Hash `json:"parentNoBftHash"`
}
...
func SetupGenesisBlock(db ethdb.Database, genesis *Genesis) (*params.ElephantChainConfig, common.Hash, error) {
	if genesis != nil && genesis.Config == nil {
		return params.AllElephanthashProtocolChanges, common.Hash{}, errGenesisNoConfig
	}
...
func (g *Genesis) configOrDefault(ghash common.Hash) *params.ElephantChainConfig {
	switch {
	case g != nil:
		return g.Config
	default:
		return params.AllElephanthashProtocolChanges
	}
}
...
func (g *Genesis) ToBlock(db ethdb.Database) *types.Block {
	...
	head := &types.Header{
		...
		Time:           new(big.Int).SetUint64(g.Timestamp * 1000),
...
func (g *Genesis) Commit(db ethdb.Database) (*types.Block, error) {
	...
	config := g.Config
	if config == nil {
		config = params.AllElephanthashProtocolChanges
	}
